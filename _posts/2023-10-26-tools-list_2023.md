...
`sudo apt install tmux fzf bat ripgrep zsh jq ncdu asciinema duf fdupes hyperfine btop speedtest-cli tre-command`

fd-find tldr ctop duf dog btop gping oha ov sss ss don't work in debian 13
