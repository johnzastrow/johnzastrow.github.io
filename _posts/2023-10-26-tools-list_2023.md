...
sudo apt install tmux fzf bat eza ripgrep zsh tldr jq ncdu asciinema duf fdupes hyperfine procs tre bandwhich ctop bpytop gping dua-cli speedtest-cli dog lazydocker navi 
