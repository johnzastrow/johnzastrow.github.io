...
| Test Name                                       | Source Host                                | End Host                                                                                | Command | Throughput(MB/s) | Latency(ns) Avg | Latency(ns) Min | Latency(ns) Max  |Throughput(Buffers/s)   |Retransmits | Errors | Avg. CPU %  |
|----|-------------|----------|---------|------------|---------------|----------------|------------------|------------------|-----------------|-----------------|-----------------------|
| Trial 1. Hello world using two internal hosts  | Sending from Windows over 2.4 Ghz Wifi to   |  linux VM wire attached to the router, each with one core, in verbose mode, for 60 secs | ntttcp.exe -s -m 1,*,192.168.1.27 -l 128K -t 60 -ns --> ntttcp -r -m 1,*,192.168.1.27 -t 60 -V        |   285         |     60.011          |      1422.133          |    4.749              |        X          |          X       |        X         |          37.993              |
